...
service:
  ...
  HendrikHaase/ProxmoxVE:
    latest_version:
      type: github
      url: HendrikHaase/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/HendrikHaase/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/HendrikHaase/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
